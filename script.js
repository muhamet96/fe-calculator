...
subtraction_button.addEventListener("click", function (e) {
  display_screen.innerText += e.target.innerText;
});
...
open_bracket_button.addEventListener("click", function (e) {
  display_screen.innerText += e.target.innerText;
});
...
closed_bracket_button.addEventListener("click", function (e) {
  display_screen.innerText += e.target.innerText;
});
